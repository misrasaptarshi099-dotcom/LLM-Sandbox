...
- Enforces user and global rate limits before touching heavy resources.
...
class AdmissionService:
    ...
    async def admit_run(
        ...
        # 2. Prompt Length and Byte Validation
        ...
        # 3. Resolve active challenge version & allowed model binding in 1 query (Rule §5)
